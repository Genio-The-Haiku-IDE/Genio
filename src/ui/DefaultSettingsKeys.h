...
const int32	kSKTrimTrailingWhitespace = B_CONTROL_OFF;	// "trim_trailing_whitespace"
...
const int32	kSKBuildOnSave = B_CONTROL_OFF;					// "build_on_save"
const int32	kSKSaveOnBuild = B_CONTROL_OFF;					// "save_on_build"
